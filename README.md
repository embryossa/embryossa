...
**Embryology Lab Director · Computational Reproductive Medicine**

I work at the intersection of clinical embryology and machine learning, developing predictive systems that translate the biological complexity of IVF into quantified, actionable probability estimates — *from in vitro to in silico*.

My core conviction is that the IVF laboratory already generates all the data needed to reason about outcomes far more rigorously than current practice allows. The challenge is not data collection but inference: building models that respect the sequential, stochastic nature of the embryological cascade, communicate uncertainty honestly, and remain interpretable to the clinicians who act on them.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/serdj-sergeev-8b5893298/)
